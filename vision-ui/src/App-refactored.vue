<script setup>
import { ref } from "vue";
import Dashboard from "./components/Dashboard-refactored.vue";
import WebcamViewer from "./components/WebcamViewer-refactored.vue";
import StreamViewer from "./components/StreamViewer-refactored.vue";
